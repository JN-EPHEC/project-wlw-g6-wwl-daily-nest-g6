...
export default function Drawerlayout() {
  return (
  <Drawer>
      <Drawer.Screen name="Acceuil" options={{title: "Acceuil"}}/>
      ...
      <Drawer.Screen name="profil" options={{title:"Profil" }}/>  
       <Drawer.Screen name="Parametres" options={{title:"Parametres" }}/>  
      <Drawer.Screen name="Avantages" options={{title:"Avantges" }}/>  
      <Drawer.Screen name="Deconnexion" options={{title:"Deconnexion" }}/>
    </Drawer>
  );
}
